...
class BaseRepositoryInterfaceMakeCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:base-repository-interface';
    ...
    */
    ...
    {
        return  base_path() . '/stubs/base-repository-interface.stub';
    }
    /**
